...
```{r Network hub percentages}
Hub_sum_table <- hubs %>% group_by(Module) %>%
  summarize(Number = n())
...
# Fig S7 Network protein connectivity comparison
...
# Fig S11 Physical protein interactor co-expression
```{r }
