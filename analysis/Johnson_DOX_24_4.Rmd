...
Fam_db <- read.csv(file = "/Users/omarjohnson/Documents/Projects/Dox_Proteomics/Data/Proteomics/Data_sets/Families/Uniprot_DIA_famalies.csv", header = TRUE)
...
```{r Protein fam, fig.height=15, fig.width=10}
# Protein families
